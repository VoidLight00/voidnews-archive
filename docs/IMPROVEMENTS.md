...
| IMP-0031 | 2026-08-12 | ab-data | AB 2026-08a 회차 생성 — 하이라이트 Top6(사용자 확정) + 오픈소스 픽 3종(cognee, paseo, watermarks-remover) | lib/ab/editions/2026-08a.ts<br>lib/ab/data.ts | c560ecf |
...
| IMP-0021 | 2026-07-17 | seo | EN 정식 SEO 표면 부재(round5 N4) — locale URL(또는 결정론 쿼리)·hreflang·alternates·영문 canonical/sitemap/OG. 현 구조는 클라이언트 토글이라 크롤러·공유 프리뷰는 ko만 노출 | — | — |
