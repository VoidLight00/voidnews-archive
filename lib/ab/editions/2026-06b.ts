  ...
  editorsPicks: [
    {
      ...
      sourceLabel: "사이트 →",
      thumbnail: { src: "/og-cache/og-pick-aside.jpg", alt: "Aside — 실제 일을 대신 하는 AI 브라우저" },
    ...
    },
    {
      ...
      sourceLabel: "GitHub →",
      thumbnail: { src: "/og-cache/og-pick-ponytail.jpg", alt: "ponytail — 가장 게으른 시니어처럼 코딩" },
    ...
    },
    {
      ...
      sourceLabel: "GitHub →",
      thumbnail: { src: "/og-cache/og-pick-cmux-mobile.jpg", alt: "cmux-mobile — 폰에서 cmux 원격 조작" },
    ...
    },
    {
      ...
      sourceLabel: "GitHub →",
      thumbnail: { src: "/og-cache/og-pick-fablelayer.jpg", alt: "fablelayer — Fable 5 규율 오픈소스 툴킷" },
