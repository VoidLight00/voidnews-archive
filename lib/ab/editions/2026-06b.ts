...
발표에서는 Fable 5 접근 차단을 시작점으로 잡고, Claude Tag와 Codex Record & Replay를 거쳐, 삼성과 SK하이닉스 사례로 한국 청중에게 연결하면 흐름이 가장 선명합니다.`,
  ...
  highlights: [
    ...
    },
    {
      rank: 2,
      tier: "feature",
      post: findPost(week25, "anthropic-c96bc983"),
      sourceWeek: "2026-w25",
      sourceCompany: "Anthropic",
      editorial: "강제 차단 이후 사용자 고지와 신뢰 문제가 뒤따랐습니다.",
    },
    {
      rank: 3,
      tier: "hero",
    ...
    },
    {
      rank: 4,
      tier: "feature",
      post: findPost(week25, "anthropic-claude-agent-sdk-8a718027"),
      sourceWeek: "2026-w25",
      sourceCompany: "Anthropic",
      editorial: "에이전트 SDK의 과금·운영 모델이 아직 정착 중이라는 신호입니다.",
    },
    {
      rank: 5,
      tier: "feature",
      post: findPost(week25, "github-copilot-agent-finder-mcp-9b36b964"),
      sourceWeek: "2026-w25",
      sourceCompany: "Microsoft / GitHub",
      editorial: "에이전트가 도구를 직접 고르는 IDE 흐름이 정식화됐습니다.",
    },
    {
      rank: 6,
      tier: "hero",
    ...
    },
    {
      rank: 8,
      tier: "feature",
      post: findPost(week26, "anthropic-project-fetch-2-claude-opus-e86c6e08"),
      sourceWeek: "2026-w26",
      sourceCompany: "Anthropic",
      editorial: "소프트웨어 에이전트 논의가 물리 세계·로봇 제어로 확장됩니다.",
    },
    {
      rank: 9,
      tier: "feature",
      post: findPost(week26, "xai-grok-build-goal-multi-step-59f9fc58"),
      sourceWeek: "2026-w26",
      sourceCompany: "xAI",
      editorial: "장시간 자율 실행에 목표·검증 루프를 붙이는 흐름입니다.",
    },
    {
      rank: 10,
      tier: "feature",
