...
export const edition2026_09b: ABEdition = {
  ...
  "modelWatchSection": {
    "kicker": "More to read",
    "title": "추가로 보면 좋을 뉴스",
    "deck": "본편과 함께 읽으면 좋은 소식입니다. 카드의 상태 칸에서 공식 발표인지 비공식 자료인지 구분할 수 있습니다.",
    "navLabel": {
      "ko": "추가 뉴스",
      "en": "More news"
    }
  ...
  "modelWatch": [
    ...
    {
      "title": "Claude Opus 5.5 시스템 프롬프트 추출본이 공개됐습니다",
      "slug": "claude-opus-5-5-system-prompt-extract",
      "deck": "도구 정의와 에이전트 규칙까지 담긴 비공식 추출본이고, Anthropic은 같은 날 앱용 공식본을 따로 공개했습니다.",
      "category": "모델 운영 · 시스템 프롬프트",
      "sourceUrl": "https://github.com/cbrunner/opus-5.5-system-prompt-components",
      "sourceLabel": "추출본 정리 저장소",
      "guideUrl": "https://platform.claude.com/docs/en/release-notes/system-prompts/claude-opus-5-5",
      "guideLabel": "Anthropic 공식 공개본",
      "summary": "한국시간 9월 23일 새벽, Claude Opus 5.5가 작업할 때 받는 시스템 프롬프트를 담은 비공식 추출본이 GitHub에 올라왔습니다. Anthropic이 공식 문서에 공개하는 앱용 시스템 프롬프트와는 범위가 다르며, 회사가 확인한 자료가 아닙니다.",
      "body": "**비공식 추출본이 GitHub에 올라왔습니다**\n시스템 프롬프트는 AI 서비스가 대화를 시작할 때 모델에게 먼저 건네는 지시문입니다. 한국시간 9월 23일 새벽 3시 12분(미국 시간 9월 22일), 프롬프트 추출로 알려진 Pliny the Liberator가 CL4R1T4S 저장소에 Claude Opus 5.5의 작업 세션 기록을 올렸습니다. 약 1.9MB 분량이며, 이를 읽기 쉽게 나눈 정리 저장소에 따르면 시스템 프롬프트 부분만 26만 2,652자, 약 6만 5천~7만 토큰입니다. 그 가운데 약 16만 7천 자는 도구 정의이고, 지시문은 약 9만 5천 자입니다. 정리 저장소는 이 자료가 Anthropic 공식 문서가 아니라고 밝혔고, Anthropic의 공식 입장은 확인되지 않았습니다.\n\n**Anthropic이 직접 공개하는 공식본과는 범위가 다릅니다**\nAnthropic은 claude.ai와 모바일 앱에서 쓰는 시스템 프롬프트를 공식 문서에 모델별로 공개해 왔고, Opus 5.5 항목도 9월 22일자로 올라와 있습니다. 공식 문서는 이 프롬프트가 API에는 적용되지 않는다고 적고 있습니다. 이번 추출본은 Claude Code 형태의 작업 환경에서 받은 전체 세션으로, 도구 목록, 에이전트 작업 규칙, 기억 기능 규칙까지 들어 있다는 점이 다릅니다.\n\n**읽을 때는 구조를 보는 자료로 다룹니다**\n추출본은 실제 서비스 설정과 다를 수 있고, 배포 뒤 바뀌었을 수도 있습니다. 안전장치를 우회하는 데 쓰는 것이 아니라, 대형 서비스가 에이전트 지시문을 어떤 단위로 나누는지 보는 참고 자료로 다루는 편이 적절합니다. 정리 저장소의 목차처럼 도구 정의, 행동 원칙, 에이전트 작업 규칙, 기억 기능 규칙을 나눠 보면, 사내에서 쓰는 AI 지시문에 무엇이 빠져 있는지 확인하는 기준이 됩니다. 공식 공개본부터 읽고 추출본은 차이를 비교하는 용도로 보시는 것을 권합니다.",
      "tags": [
        "Anthropic",
        "시스템 프롬프트",
        "비공식 자료"
      ...
      "tier": "normal",
      "releaseScope": "비공식 추출본 · 공식본 별도 공개",
      "unofficial": true
    }
  ],
  "editorsPicks": [
