...
export const edition2026_05b: ABEdition = {
  ...
  closing: `한 줄로 묶으면, AI는 이번 11일 사이에 "어디서나 돌고, 인프라를 정당화하며, 기업 운영체제로 들어가는" 단계로 굳었습니다.\n\n직접 써보고 추천드리는 도구 섹션에는 tw93/Mole(macOS deep clean + AI CLI 잔재 정리), Nutlope/hallmark(anti-AI-slop 디자인 스킬), manaflow-ai/cmux(Codex CLI 분할 워크플로), cokacdir(한국어 AI 큐레이션 텔레그램 봇) 네 개를 골라뒀습니다.\n\n— VoidLight`,
  highlights: [
    {
      rank: 1,
      tier: "hero",
  ...
  editorsPicks: [
    ...
    {
      title: "cokacdir",
      deck: "AI 신규 소식·릴리스를 실시간으로 publish하는 한국어 큐레이션 봇",
      category: "AI 정보 큐레이션 / 텔레그램 봇",
      sourceUrl: "https://t.me/cokacdir",
      sourceLabel: "Telegram →",
      summary: "AI 신규 소식·릴리스를 실시간으로 publish하는 한국어 큐레이션 봇. 본 회차 4라운드 교차 검증의 baseline source로도 사용 중.",
      body: "AI 신규 소식·릴리스를 실시간으로 publish하는 한국어 큐레이션 봇. 본 회차 4라운드 교차 검증의 baseline source로도 사용 중.",
      editorial: "직접 구독 중인 한국어 AI 큐레이션 채널.",
      tags: ["큐레이션", "직접사용"],
      tier: "feature",
      thumbnail: {
        src: "/og-cache/cokacdir-telegram-fallback.png",
        alt: "cokacdir Telegram 채널",
      },
    },
  ],
  demoCards: [
