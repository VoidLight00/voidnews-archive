...
export const edition2026_05a: ABEdition = {
  slug: "2026-05a",
  volume: 3,
  title: "GPT-5.5·Googlebook·Claude Code·Figure — 3주 동안 가장 퍼진 AI 흐름 11",
  theme: "2026년 4월 말~5월 중순 — 모델 기본값, AI 노트북, 코딩 에이전트, 음성·이미지·영상 제작이 한꺼번에 움직인 구간",
  period: "2026-04-27 ~ 2026-05-14",
  coveredWeeks: ["2026-w18", "2026-w19", "2026-w20"],
  announceDate: "2026-05-14",
  intro: `이번 3주는 "새 모델 하나가 나왔다"보다 더 큰 흐름으로 읽히는 구간이었습니다.

OpenAI는 GPT-5.5와 실시간 음성 모델로 기본 사용 경험을 다시 흔들었고, Google은 Googlebook과 Nano Banana 2로 AI가 기기와 제작 환경 안으로 들어가는 장면을 보여줬습니다. Anthropic의 Claude Code와 OpenAI Codex는 코딩 도구를 채팅창이 아니라 목표·세션·브라우저를 다루는 에이전트 운영 콘솔 쪽으로 밀고 있습니다.

그래서 이번 레터는 기존 VOL.03과 VOL.04의 겹치는 흐름을 걷어내고, 발표장에서 바로 전달력이 있는 11개만 다시 골랐습니다. 기준은 세 가지입니다. 일반 사용자가 바로 체감할 변화인가, 개발자와 크리에이터의 작업 방식이 실제로 바뀌는가, 그리고 단순 성능 뉴스가 아니라 앞으로의 AI 사용 습관을 설명해 주는가.

마지막에는 RTK, Harness, Scenic, Claude Code NotebookLM처럼 이 흐름을 실제 작업 시스템으로 옮길 때 참고할 만한 도구를 따로 붙였습니다.`,
  closing: `이번 3주 큐레이션을 한 줄로 묶으면, AI는 더 이상 채팅창 안의 답변기가 아니라 작업 환경 전체를 움직이는 운영 레이어가 되고 있습니다.

GPT-5.5는 기본 모델 경험을 다시 재게 만들고, Googlebook은 AI가 하드웨어 사용 방식으로 들어오는 장면을 보여줍니다. Claude Code와 Codex는 목표, 병렬 세션, 브라우저, 원격 환경으로 확장되며 코딩 도구를 에이전트 운영 콘솔에 가깝게 바꾸고 있습니다. Realtime Voice와 xAI Voice Cloning은 화면 중심의 AI를 목소리 인터페이스로 넓히고, Human Operator와 Figure Helix-02는 AI가 디지털 화면을 넘어 물리 세계의 동작과 협업으로 확장되는 장면을 보여줍니다.
  ...
  highlights: [
    {
      ...
      post: {
        date: "5/05",
        platform: "X",
        title: "GPT-5.5 vs Opus 4.7 vs GPT-5.4 — 기본 모델 뉴스보다 중요한 실제 코딩 비교",
        slug: "gpt-55-vs-opus-47-vs-gpt-54-기본-모델-뉴스보다-중요한-실제-코딩-비교",
        summary: "OpenAI의 GPT-5.5 Instant 롤아웃은 출발점이고, 핵심은 GPT-5.5·Opus 4.7·GPT-5.4를 56개 실제 코딩 태스크로 비교했을 때 성공률·비용·패치 성향이 다르게 갈린다는 점입니다.",
        content: `**이게 뭐예요?**
GPT-5.5 Instant는 ChatGPT의 새 기본 모델로 롤아웃된 소식이지만, 이 카드의 핵심은 모델 이름 하나가 아니라 GPT-5.5·Opus 4.7·GPT-5.4를 실제 코딩 태스크에서 나란히 비교한 결과입니다.

**무엇이 달라졌나?**
AISI 평가와 초기 사용자 반응에서는 GPT-5.5가 더 강한 추론과 낮아진 환각, 더 개인화된 응답을 보여준다는 신호가 나왔습니다. 동시에 Reddit의 56개 실제 코딩 태스크 비교에서는 세 모델의 성공률·비용·패치 성향이 서로 다르게 나타났습니다.
...
GPT-5.5가 무조건 모든 상황에서 정답이라는 뜻은 아닙니다. 성공률, 비용, 코드 품질, 리뷰 통과 가능성, UI 코드 성향을 작업별로 나눠 보는 것이 더 현실적입니다.`,
      ...
      keyQuote: "모델 뉴스보다 중요한 것은 내 작업에서 어떤 모델이 실제로 이기는가다",
      editorial: "가장 앞에 둘 카드입니다. GPT-5.5 출시 소식에 실제 코딩 비교군을 붙여, 매일 쓰는 ChatGPT와 코딩 에이전트 선택 기준이 어떻게 달라지는지 보여줍니다."
    },
    {
      rank: 2,
      tier: "hero",
      post: {
        ...
        slug: "googlebook-gemini-intelligence를-전제로-설계한-ai-노트북",
...
아직 출시 전 제품 카테고리입니다. 가격, 실제 성능, 학교·업무 계정 관리 정책, 파트너별 사양은 출시 시점에 다시 확인해야 합니다.`,
    ...
    },
    {
      ...
      post: {
        ...
        slug: "claude-code-agent-view-goal-코딩-도구가-에이전트-운영-콘솔이-되는-순간",
...
OpenAI Codex의 /goal과 같은 이름처럼 보여도 제품과 출처가 다릅니다. 둘은 합칠 항목이 아니라, 서로 다른 코딩 에이전트가 같은 방향으로 진화하고 있다는 교차 신호로 봐야 합니다.`,
        ...
        thumbnail: {
          src: "/ab/2026-05a/goal-loop-infographic.svg",
          alt: "goal 기반 에이전트 작업 루프 인포그래픽",
          caption: "/goal은 한 번 답하는 채팅이 아니라 완료 조건을 기준으로 실행과 검증을 반복하는 작업 루프"
        },
        images: [
          {
            src: "/ab/2026-05a/goal-loop-infographic.svg",
            alt: "목표 선언, 에이전트 실행, 검증, 반복으로 이어지는 goal 루프",
            caption: "목표를 먼저 고정하고, 실행과 검증을 반복해 완료 조건을 만족할 때까지 이어간다"
          }
        ],
      ...
      editorial: "Claude Code 공식 changelog와 문서만으로 정리한 카드입니다. 여러 세션과 /goal을 함께 보면 Claude Code 사용자에게 바로 체감되는 변화입니다."
    },
    {
      rank: 4,
      tier: "feature",
      post: {
        ...
        slug: "openai-codex-goal-chrome-extension-코딩-에이전트가-브라우저와-원격-환경으로-확장",
        summary: "OpenAI Codex는 /goal로 완료 기준을 다루고, Chrome extension으로 로그인된 웹앱 작업까지 확장됩니다. 공식 changelog와 문서 기준으로 브라우저·원격 연결 흐름을 확인할 수 있습니다.",
        content: `**이게 뭐예요?**
...
**어떻게 읽을까?**
공식 문서에서 확인되는 핵심은 Codex가 Chrome extension, in-app browser, remote connections를 통해 코드 저장소 바깥의 작업 표면으로 확장된다는 점입니다. 웹앱과 원격 환경을 다룰수록 에이전트는 더 강해지지만, 접근 범위와 권한 설계도 같이 중요해집니다.
...
브라우저와 원격 환경으로 확장될수록 권한 관리가 더 중요해집니다. 어떤 사이트를 허용할지, 로그인 컨텍스트가 어디까지 저장되는지, 조직 계정에서 허용해도 되는지가 핵심입니다.`,
        ...
        thumbnail: {
          ...
          alt: "OpenAI Codex /goal + Chrome extension — 코딩 에이전트가 브라우저와 원격 환경으로 확장",
        },
      },
      sourceWeek: "2026-w20",
      sourceCompany: "OpenAI / Codex",
      keyQuote: "Codex는 목표, 브라우저, 원격 환경까지 에이전트 표면을 넓히고 있다",
      editorial: "OpenAI 공식 changelog와 Codex 문서를 기준으로 정리했습니다. Chrome extension과 remote connections 흐름은 브라우저 기반 업무까지 코딩 에이전트가 넓어지는 신호입니다."
    },
    {
      rank: 5,
      tier: "feature",
      post: {
        ...
        slug: "openai-realtime-voice-models-음성-에이전트용-실시간-모델-3종-공개",
...
음성 모델은 지연 시간과 비용이 경험을 결정합니다. 모델 이름보다 분당 과금, 캐시 입력, 지원 언어, 녹취 보관 정책을 함께 확인해야 합니다.`,
    ...
    },
    {
      ...
      post: {
        ...
        slug: "xai-grok-api-voice-cloning-목소리도-에이전트-제품의-기본-부품이-됨",
...
음성권, 동의, 본인 확인, 도용 방지 정책이 핵심입니다. 목소리 복제는 편리함과 위험이 같이 커지는 영역입니다.`,
    ...
    },
    {
      ...
      post: {
        ...
        slug: "mit-media-lab-human-operator-전기근육자극으로-ai가-사람-손을-움직이는-실험",
...
이 항목은 상용 제품이라기보다 실험과 해커톤 맥락에 가깝습니다. 안전성, 동의, 착용 편의성, 재현 가능성을 반드시 분리해서 봐야 합니다.`,
        ...
        thumbnail: {
          ...
          alt: "MIT Media Lab Human Operator — 전기근육자극으로 AI가 사람 손을 움직이는 실험",
        },
      },
      sourceWeek: "2026-w18",
    ...
    },
    {
      ...
      post: {
        ...
        slug: "google-ai-studio-nano-banana-2-이미지-제작이-앱-빌드-워크플로우로-들어옴",
...
이미지 안 텍스트가 좋아졌다고 해도 숫자, 브랜드 문구, 법적 문구는 최종 검수가 필요합니다. 실제 사용 전에는 모델 이름, 비용, 지역 조건도 확인해야 합니다.`,
        ...
        thumbnail: {
          ...
          alt: "Google AI Studio Nano Banana 2 — 이미지 제작이 앱 빌드 워크플로우로 들어옴",
        },
      },
      sourceWeek: "2026-w19",
    ...
    },
    {
      ...
      post: {
        ...
        slug: "alibaba-happyhorse-10-영상-생성-경쟁이-오디오립싱크api-생태계로-확장",
...
데모 품질과 실제 사용 가능성은 다릅니다. 상업 이용 조건, 워터마크, 한국어 텍스트 처리, 편집 가능성, 지역 제한을 확인해야 합니다.`,
        ...
        thumbnail: {
          ...
          alt: "Alibaba HappyHorse 1.0 — 영상 생성 경쟁이 오디오·립싱크·API 생태계로 확장",
        },
      },
      sourceWeek: "2026-w18",
    ...
    },
    {
      ...
      post: {
        date: "5/08",
        platform: "X",
        title: "Figure Helix-02 Bedroom Tidy — 두 휴머노이드가 침실을 같이 정리하는 장면",
        slug: "figure-helix-02-bedroom-tidy-두-휴머노이드가-침실을-같이-정리하는-장면",
        summary: "Figure가 Helix-02 휴머노이드 두 대가 침실을 2분 안에 정리하는 데모를 공개했습니다. 공유 플래너나 중앙 조정자 없이 각 로봇이 카메라로 상황을 읽고 상대 의도를 추론한다는 점이 핵심입니다.",
        content: `**이게 뭐예요?**
Figure의 Helix-02 Bedroom Tidy는 휴머노이드 두 대가 침실을 정리하는 공식 데모입니다. 문을 열고, 옷을 걸고, 헤드폰을 치우고, 책을 덮고, 쓰레기를 버리고, 의자를 밀어 넣고, 함께 침대를 정리하는 장면을 보여줍니다.

**무엇이 달라졌나?**
Figure는 이 데모가 단일 학습 Vision-Language-Action 정책으로 동작한다고 설명합니다. 더 중요한 표현은 공유 플래너, 메시지 패싱, 중앙 조정자가 없다는 점입니다. 각 로봇이 자기 카메라로 방을 보고, 사람이 침대 시트를 같이 접을 때처럼 상대의 움직임에서 의도를 추론하는 구조입니다.

**왜 바이럴한가?**
휴머노이드 로봇이 공장 데모를 넘어 집 안의 어수선한 공간을 정리하는 장면은 대중적으로 이해가 빠릅니다. AI 에이전트가 화면 안에서 파일을 고치는 단계에서, 실제 물리 공간의 물건을 옮기고 협업하는 방향으로 확장되는 상징적인 장면입니다.

**읽을 때 볼 점**
공식 데모는 강하지만, 아직 일반 가정용 제품 출시나 가격, 안전 인증, 실패율을 보여주는 자료는 아닙니다. 발표에서는 상용화 확정이 아니라 물리 AI와 범용 로봇 협업의 방향성으로 읽는 편이 좋습니다.`,
        source: "https://www.figure.ai/news/helix-02-bedroom-tidy",
        officialUrl: "https://www.figure.ai/news/helix-02-bedroom-tidy",
        backupUrls: [
          {
            label: "Helix-02 공식 소개",
            url: "https://www.figure.ai/news/helix-02"
          },
          {
            label: "YouTube 공식 영상",
            url: "https://www.youtube.com/watch?v=8xEuFQz4E4A"
          },
          {
            label: "Living Room Tidy 공식 데모",
            url: "https://www.figure.ai/news/helix-02-living-room-tidy"
          }
        ],
        tags: ["Figure", "Helix02", "Humanoid", "Robotics", "PhysicalAI"],
        featured: true,
        thumbnail: {
          src: "/og-cache/figure-helix-02-bedroom-tidy-두-휴머노이드가-침실-d34db0ba.jpg",
          alt: "Figure Helix-02 Bedroom Tidy — 두 휴머노이드가 침실을 같이 정리하는 장면",
        },
      },
      sourceWeek: "2026-w20",
      sourceCompany: "Figure AI / Robotics",
      keyQuote: "AI 에이전트가 화면을 넘어 실제 방 정리와 로봇 협업으로 확장된다",
      editorial: "Human Operator가 실험적 물리 AI라면, Figure Helix-02는 대중이 바로 이해할 수 있는 휴머노이드 협업 데모입니다. 단, 공식 데모와 상용 제품 가능성은 분리해서 설명하는 것이 좋습니다."
    },
    {
      rank: 11,
      tier: "normal",
      post: {
        ...
        slug: "andrej-karpathy-claudemd-코딩은-타이핑에서-에이전트-위임으로-이동",
...
좋은 사용자는 프롬프트 한 줄을 잘 쓰는 사람이 아니라, 목표·제약·테스트·완료 조건을 문서화해 에이전트가 오래 굴러가도 망가지지 않게 만드는 사람입니다.`,
  ...
  demoCards: [
    {
      title: "궁합방 — GPT-5.5 기획 → Codex 실행만으로 하루 만에 만든 서비스",
      slug: "궁합방-gpt-55-기획-codex-실행만으로-하루-만에-만든-서비스",
      subtitle: "GPT-5.5의 기획력과 Codex 에이전트 실행력을 보여주는 실전 데모",
      category: "GPT-5.5 실전 제작 사례",
      url: "https://gunghap-room.vercel.app/?locale=ko-KR",
      label: "궁합방 데모 열기 →",
      summary: "GPT-5.5로 서비스 기획을 잡고, Codex에 계속 진행만 맡겼을 때 하루 만에 실제 배포 가능한 웹서비스까지 이어진 사례입니다.",
      workflow: "GPT-5.5 기획 → Codex에 '계속 진행' 위임 → 하루 만에 Vercel 배포 결과",
      body: `이 데모는 GPT-5.5가 얼마나 강한지 설명으로만 보여주는 카드가 아니라, 실제 결과물로 보여주는 사례입니다.

핵심은 복잡한 개발 명세를 처음부터 사람이 전부 쓴 것이 아니라는 점입니다. GPT-5.5로 서비스 방향과 사용자 경험을 잡고, 이후 Codex에 계속 진행을 맡기면서 기획이 실제 웹서비스로 이어졌습니다.

발표에서는 이 카드를 "모델 성능이 좋아졌다"의 예시가 아니라, 좋은 기획 모델과 코딩 에이전트를 연결했을 때 하루 단위로 무엇이 나오는지를 보여주는 실전 증거로 소개하면 좋습니다.`,
      tags: ["GPT-5.5", "Codex", "VibeCoding", "Vercel", "실전데모"]
    }
  ],
  editorsPicks: [
    {
      title: "RTK — LLM 토큰 사용량을 60~90% 줄이는 Rust CLI proxy",
      slug: "rtk-llm-토큰-사용량을-6090-줄이는-rust-cli-proxy",
...
빌드 로그가 길거나 에이전트가 여러 번 검증 루프를 돌리는 프로젝트일수록 효과가 큽니다. 이번 큐레이션의 에이전트를 오래 굴리는 능력이라는 흐름을 비용과 운영 측면에서 보완하는 도구입니다.`,
    ...
    },
    {
      ...
      slug: "harness-도메인별-에이전트-팀과-스킬을-설계하는-meta-skill",
      subtitle: "직접 써본 툴 추천",
...
볼 포인트는 meta-skill이라는 점입니다. 결과물을 바로 만들어 주는 도구라기보다, 결과물을 반복 생산하는 팀 구조와 규칙을 만드는 도구로 보면 이해가 쉽습니다.`,
      ...
      tier: "feature",
      thumbnail: {
        src: "/og-cache/harness-도메인별-에이전트-팀과-스킬을-설계하는-meta-skill-4a239b48.png",
        alt: "Harness — 도메인별 에이전트 팀과 스킬을 설계하는 meta-skill",
      },
    },
    {
      title: "Scenic — AI 영상 프롬프트 갤러리와 Seedance 2.0 기반 예시 탐색",
      slug: "scenic-ai-영상-프롬프트-갤러리와-seedance-20-기반-예시-탐색",
...
볼 포인트는 프롬프트 자체보다 구조입니다. 어떤 장면 설명이 들어가고, 어떤 카메라 동작이 붙고, 어떤 스타일 단어가 결과를 바꾸는지 관찰하면 자기 영상 프롬프트를 더 빨리 다듬을 수 있습니다.`,
      editorial: "사용자가 직접 써보고 추천하는 도구 섹션에 넣었습니다. HappyHorse 같은 영상 모델을 다룰 때 바로 참고할 수 있는 프롬프트 갤러리입니다.",
      tags: ["Scenic", "VideoGeneration", "PromptGallery", "Seedance", "영상프롬프트"],
      tier: "normal",
      thumbnail: {
        src: "/og-cache/scenic-ai-영상-프롬프트-갤러리와-seedance-2-0-기반-예-9e6acf0e.png",
        alt: "Scenic — AI 영상 프롬프트 갤러리와 Seedance 2.0 기반 예시 탐색",
      },
    },
    {
      title: "Claude Code NotebookLM — Claude Code 안에서 NotebookLM을 다루는 /notebooklm 스킬 패키지",
      slug: "claude-code-notebooklm-claude-code-안에서-notebooklm을-다루는-noteb",
      subtitle: "내가 직접 깎은 툴",
...
보안 측면에서는 Google 계정 인증 파일을 로컬에 두는 흐름이므로, auth 파일 공유 금지와 로컬 자격증명 관리가 중요합니다.`,
      ...
      tier: "hero",
      thumbnail: {
        src: "/og-cache/claude-code-notebooklm-claude-code-안에서-n-5d8801e6.png",
        alt: "Claude Code NotebookLM — Claude Code 안에서 NotebookLM을 다루는 /notebooklm 스킬 패키지",
      },
    }
  ]
};
