...
export const edition2026_05a: ABEdition = {
  slug: "2026-05a",
  volume: 4,
  title: "Gemini Intelligence·Codex Safety·GPT-5.5-Cyber — AI가 OS와 에이전트 운영 레이어로 들어온 주",
  theme: "Google은 Android와 Googlebook을 Gemini 실행 레이어로 바꾸고, OpenAI는 Codex와 Cyber 모델을 안전·접근 통제 관점으로 정리한 회차",
  period: "2026-05-07 ~ 2026-05-14",
  coveredWeeks: ["2026-w20"],
  announceDate: "2026-05-14",
  intro: "이번 회차의 중심은 Google입니다. Android는 단순한 operating system에서 Gemini Intelligence가 들어간 intelligence system으로 확장되고, Googlebook은 Gemini를 전제로 설계된 노트북 카테고리로 제시됐습니다. AI가 챗봇 앱 안에만 머무르는 것이 아니라 스마트폰, 브라우저, 위젯, 노트북의 사용 방식 자체로 들어오는 장면입니다.\n\nOpenAI 쪽에서는 Codex를 안전하게 운영하는 방식과 GPT-5.5-Cyber의 Trusted Access 구조가 함께 잡혔습니다. 강한 에이전트와 강한 모델을 쓰는 시대에는 목표, 권한, 네트워크, 승인 규칙, 계정 보안, 접근 통제가 같이 중요해집니다. 여기에 GitHub Copilot의 usage-based billing과 Perplexity Computer의 enterprise 업데이트를 연결하면, AI는 이제 성능 경쟁을 넘어 보안·비용·데이터 권한까지 운영해야 하는 실행 레이어가 되고 있습니다.",
  closing: "이번 회차의 한 줄은 분명합니다. AI는 이제 챗봇 앱 안에 머무르지 않고, 운영체제·브라우저·노트북·코딩 에이전트·보안 워크플로우를 움직이는 실행 레이어로 들어오고 있습니다.\n\nGoogle Gemini Intelligence는 개인이 매일 쓰는 스마트폰과 노트북 안으로 에이전트를 넣는 흐름이고, OpenAI Codex safety는 그 에이전트에게 일을 맡길 때 필요한 경계 설계를 보여줍니다. GPT-5.5-Cyber와 Trusted Access는 강력한 모델을 누구에게 열 것인지의 문제를 던지고, Copilot billing은 AI 코딩 도구가 비용 관리 대상이 됐음을 보여줍니다. Perplexity Computer는 기업 데이터와 반복 업무를 연결하는 또 다른 실행 레이어입니다.\n\n그래서 앞으로의 질문은 '어떤 AI를 쓰느냐'에서 한 단계 이동합니다. 내 업무의 어느 부분을 OS, 에이전트, 데이터 워크플로우에 맡길 것인가, 그리고 그 권한과 비용과 안전장치를 어떻게 설계할 것인가가 핵심입니다.\n\n— VoidLight",
  highlights: [
    {
      rank: 1,
      tier: "hero",
      ...
      keyQuote: "Android가 operating system에서 intelligence system으로 이동한다",
      editorial: "이번 회차의 중심 카드입니다. Google의 메시지는 AI 앱을 하나 더 설치하라는 것이 아니라, 사용자가 이미 매일 쓰는 스마트폰 OS 자체가 여러 앱과 정보를 연결해 일을 대신 처리하는 방향입니다. 학생들에게는 '폰 안에 에이전트가 들어온다'는 설명이 가장 직관적입니다."
    },
    {
      rank: 2,
      tier: "feature",
      ...
      sourceWeek: "2026-w20",
      sourceCompany: "Google / Android",
      keyQuote: "Chromebook의 후속이라기보다 Gemini용 개인 작업 장치에 가깝다",
      editorial: "Googlebook은 Gemini Intelligence가 소프트웨어 기능을 넘어 기기 설계의 전제가 되는 흐름을 보여줍니다. 아직 출시 전 제품이지만, AI가 노트북의 사용 방식을 어떻게 바꿀지 설명하기 좋은 카드입니다."
    },
    {
      rank: 3,
      tier: "feature",
      ...
      keyQuote: "에이전트에게 일을 맡기는 능력은 권한과 경계를 설계하는 능력이다",
      editorial: "Gemini가 OS 안으로 들어오는 카드와 짝이 되는 실전 운영 카드입니다. 에이전트가 더 많은 일을 처리할수록, 사용자는 프롬프트보다 권한·네트워크·승인 규칙·관측을 잘 설계해야 합니다."
    },
    {
      rank: 4,
      tier: "normal",
      ...
      sourceWeek: "2026-w20",
      sourceCompany: "OpenAI",
      keyQuote: "강력한 모델은 기능보다 접근 통제와 책임 있는 사용 맥락이 함께 중요해진다",
      editorial: "핵심은 공격 기술이 아니라 접근 통제와 방어적 사용입니다. 고성능 사이버 모델을 어떻게 열고, 누구에게 맡기고, 어떤 계정 보안 조건을 둘 것인지가 중요합니다."
    },
    {
      rank: 5,
      tier: "normal",
  ...
  editorsPicks: [
    {
      title: "에이전트 운영 체크리스트 — 목표, 권한, 네트워크, 승인, 비용",
      subtitle: "Codex safety와 Copilot billing을 실무 규칙으로 바꾸기",
      category: "AI 에이전트 운영",
      sourceUrl: "https://openai.com/index/running-codex-safely/",
      sourceLabel: "Codex safety 보기 →",
