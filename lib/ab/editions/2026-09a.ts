...
export const edition2026_09a: ABEdition = {
  ...
  intro: "이번 2주는 주요 모델을 직접 업무에 적용하는 방법부터 살펴봅니다. Astra·Fable 5.1·Gemini 3.8 Flash에서 시작 설정과 사용량을 짚고, Images 2.5의 편집, Atlas의 공간 탐색, Lyria 3.5의 음악으로 이어갑니다. 각 주제에 공식 원문, 실제 시작 경로, 해볼 과제와 결과 확인 기준을 함께 담았습니다.",
  closing: "공식 설명과 공개 사례를 참고해 자신의 업무에 맞는 과제 하나를 골라 보십시오. 입력 자료와 완료 조건을 정하고, 결과 파일·근거·사용량을 확인하면 다음 도구를 선택할 기준이 생깁니다. 각 주제의 실습 예시는 직접 적용할 때 사용할 요청 방법과 점검 기준입니다.",
  coreFlow: [
    "Astra 적용",
    "Fable 긴 작업",
    "Gemini 자료 활용",
  ...
  highlights: [
    {
      ...
      post: {
        ...
        backupUrls: [
          ...
          {
            label: "Astra·Fable 공개 제작 비교",
            url: "https://www.chaseai.io/blog/gpt-6-astra-vs-claude-fable-5-1"
          },
          {
            label: "VOIDLIGHT · 생각의 강도 활용 해설",
            url: "https://www.threads.com/@voidlight00/post/DdAwEbTE1oV"
          }
        ],
        thumbnail: {
          ...
          tables: [
            {
              ...
              rows: [
                [
                  {
                    ko: "포트나이트형 게임",
                    en: "Fortnite-style game"
                  },
                  {
                    ko: "기능·조작 완성도 우세",
                    en: "More complete controls"
                  },
                  {
                    ko: "카메라·충돌 문제",
                    en: "Camera/collision issues"
                  },
                  {
                    ko: "같은 요청·참고 이미지",
                    en: "Same brief/references"
                  }
                ],
                [
                  {
                  ...
                  {
                    ko: "기능보다 외관 평가",
                    en: "Appearance assessed"
                  }
                ],
                [
                  {
                    ko: "메시지 전송 설명 영상",
                    en: "Messaging explainer"
                  },
                  {
                    ko: "우열 없음",
                    en: "Tie"
                  ...
                  {
                    ko: "같은 외부 도구·스킬",
                    en: "Same external tools/skill"
                  }
                ],
                [
                  {
                    ko: "3D 지구본 대시보드",
                    en: "3D globe dashboard"
                  },
                  {
                    ko: "읽기·사용에 집중",
                    en: "More usable"
                  ...
                  {
                    ko: "제작자의 사용성 평가",
                    en: "Creator’s usability judgment"
                  }
                ]
              ],
              note: {
                ko: "Chase AI의 9월 5일 비교입니다. 네 과제에 대한 제작자의 평가이며 전체 모델 순위는 아닙니다. 원문이 보고한 비용 우위도 특정 벤치마크 실행 조건의 결과이므로 API 단가나 모든 작업의 비용으로 일반화하지 않습니다.",
                en: "Chase AI, September 5: one creator’s four builds, not a universal ranking. Reported cost advantages concern particular benchmark runs, not API unit prices or every workload."
              },
              sourceUrl: "https://www.chaseai.io/blog/gpt-6-astra-vs-claude-fable-5-1",
              sourceLabel: {
                ko: "제작자의 비교 원문과 영상",
                en: "Creator’s article and video"
              }
            }
          ]
        },
        threadsUrl: "https://www.threads.com/@voidlight00/post/DdAwEbTE1oV"
      },
      sourceWeek: "2026-w36",
    ...
    },
    {
      ...
      post: {
        ...
        en: {
          ...
          summary: "Fable 5.1 targets long coding and knowledge-work tasks with lower cache-read pricing. Compare source documents, request targeted edits, and hand off only necessary context. Subscription allowances and API savings are different. As a practice exercise, compare conflicting figures in sample documents, request a one-paragraph edit, and check both the numbers and edit scope.",
          content: "Fable 5.1 targets long coding and knowledge-work tasks with lower cache-read pricing. Compare source documents, request targeted edits, and hand off only necessary context. Subscription allowances and API savings are different. As a practice exercise, compare conflicting figures in sample documents, request a one-paragraph edit, and check both the numbers and edit scope.\n\n**Working with Astra**\nThe Astra supplement compares four public builds and a reported prototype-then-refine workflow. Transfer the current files and the behaviors to preserve when switching models.\nhttps://voidnews-archive.vercel.app/ab/2026-09a/gpt-6-astra-practical-workflows/#astra-fable-comparison"
        },
    ...
    },
    {
      ...
      post: {
        ...
        en: {
          ...
          summary: "Gemini 3.8 Flash strengthens long coding and multi-step reasoning. Confirm the available model in Gemini or AI Studio, keep source references, and validate missing information. Flash Cyber has separate access conditions. For practice, compare three sample venues for 50 attendees, change the requirement to 80, and check capacity, missing information and source references.",
          content: "Gemini 3.8 Flash strengthens long coding and multi-step reasoning. Confirm the available model in Gemini or AI Studio, keep source references, and validate missing information. Flash Cyber has separate access conditions. For practice, compare three sample venues for 50 attendees, change the requirement to 80, and check capacity, missing information and source references."
        },
    ...
    },
    {
      ...
      post: {
        ...
        backupUrls: [
          ...
          {
            label: "이미지 편집 참고 예제 · GPT Image 2",
            url: "https://github.com/wuyoscar/GPT-Image2-Skill/blob/7268a1d977c3084527ef349e94bd7e032f06ea2f/skills/gpt-image/references/gallery-edit-endpoint-showcase.md"
          },
          {
            label: "VOIDLIGHT · 별자리와 띠 공개 요청문",
            url: "https://www.threads.com/@voidlight00/post/DdBpcyFk5Aa"
          },
          {
            label: "VOIDLIGHT · 창작 결과 이미지",
            url: "https://www.threads.com/@voidlight00/post/DdBpdUvk1V2"
          }
        ],
        thumbnail: {
        ...
        en: {
          ...
          summary: "OpenAI released Images 2.5 on September 8 with improved reference fidelity and iterative editing. Explore Sketch, comments and templates, compare the Flare and Sunburst API models, and try a three-step product-photo exercise that checks which details survive each edit.",
          content: "OpenAI released Images 2.5 on September 8 with improved reference fidelity and iterative editing. Explore Sketch, comments and templates, compare the Flare and Sunburst API models, and try a three-step product-photo exercise that checks which details survive each edit.\n\n**Compare inputs and results**\nThe supplement pairs each source image with its edited result. Two official Images 2.5 examples are followed by two GPT Image 2 repository examples. Inspect what changed and what should remain stable.\n\n**A Threads creative prompt: zodiac guardian**\nVOIDLIGHT’s September 8 post combines a star sign and a Chinese zodiac animal into one guardian character. Its Libra-and-Dragon result combines a dragon, scales and celestial symbols. Specify your two inputs, colors, composition and required symbols to plan your own character. The post does not identify the generation model, so it is not classified as an Images 2.5 performance example.\nPrompt: https://www.threads.com/@voidlight00/post/DdBpcyFk5Aa\nResult: https://www.threads.com/@voidlight00/post/DdBpdUvk1V2"
        },
        releaseScope: "ChatGPT·API / 순차 제공",
        supplement: {
          id: "image-editing-cases",
          title: {
            ko: "추가 자료 · 입력과 결과로 보는 이미지 활용",
            en: "Further reading · Image inputs and results"
          },
          intro: {
            ko: "옷만 바꾸기, 장면의 분위기 바꾸기, 완성된 포스터를 광고판에 적용하기를 비교합니다. 앞의 두 쌍은 Images 2.5 공식 예시이며, 뒤의 두 쌍은 카카오톡에서 공유된 GPT Image 2 자료의 참고 사례입니다. 모델 간 성능 대결이 아니라 편집 목적별 활용 비교입니다.",
            en: "Compare changing clothes, altering a scene and placing a poster in an ad display. The first two pairs are official Images 2.5 examples; the last two come from a GPT Image 2 repository shared in the community. These illustrate editing tasks, not a head-to-head model test."
          },
          cases: [
            {
              id: "portrait-clothes",
              ...
              prompt: {
                ko: "이 사진의 인물과 자세, 파란 배경을 유지하고 의상을 아이보리 턱시도와 검은 나비넥타이로 바꿔 주세요.",
                en: "Keep the person, pose and blue background. Change the clothing to an ivory tuxedo and black bow tie."
              },
              focus: {
                ko: "얼굴·자세·배경과 옷의 경계를 각각 비교합니다.",
                en: "Compare face, pose, background and clothing edges."
              },
              limit: {
                ko: "OpenAI 제공 비교 예시입니다. 아래 요청문은 따라 해 볼 예시이며 원래 생성 요청문은 아닙니다.",
                en: "OpenAI’s selected example. The suggested prompt is new, not the original generation prompt."
              }
            },
            {
              id: "dog-costume",
              title: {
                ko: "반려동물 사진에 의상 더하기",
                en: "Add a pet costume"
              },
              model: "ChatGPT Images 2.5",
              kind: "official",
              sourceUrl: "https://openai.com/index/introducing-chatgpt-images-2-5/",
              sourceLabel: {
                ko: "OpenAI · 반려동물 사진 비교",
                en: "OpenAI · Dog example"
              },
              input: {
                src: "/ab/2026-09a/cases/stuntman-dog-before.png",
                alt: "A small cream-colored curly-haired dog stands on a leash among black patio chairs in bright sunlight.",
                caption: "원문 입력·결과 비교 자료 / Original comparison asset"
              },
              output: {
                src: "/ab/2026-09a/cases/stuntman-dog-after.webp",
                alt: "The same cream-colored dog stands on the patio wearing a white stunt suit and helmet decorated with red and blue stripes and stars, with a “STUNTMAN” patch on its chest.",
                caption: "원문 입력·결과 비교 자료 / Original comparison asset"
              },
              promptKind: "suggested",
              prompt: {
                ko: "강아지의 얼굴과 자세, 주변 의자와 그림자는 유지하고 스턴트 의상과 헬멧을 입혀 주세요.",
                en: "Preserve the dog’s face, pose, nearby chairs and shadows. Add a stunt costume and helmet."
              },
              focus: {
                ko: "털과 얼굴, 의자·바닥이 어떻게 남았는지 확인합니다.",
                en: "Inspect the fur, face, chairs and floor."
              },
              limit: {
                ko: "OpenAI 제공 비교 예시입니다. 아래 요청문은 따라 해 볼 예시이며 원래 생성 요청문은 아닙니다.",
                en: "OpenAI’s selected example. The suggested prompt is new, not the original generation prompt."
            ...
            },
            {
              id: "chess-season",
              title: {
                ko: "체스 장면의 계절과 조명 바꾸기",
                en: "Change a scene’s season"
              },
              model: "GPT Image 2 · repository example",
              kind: "community",
              sourceUrl: "https://github.com/wuyoscar/GPT-Image2-Skill/blob/7268a1d977c3084527ef349e94bd7e032f06ea2f/skills/gpt-image/references/gallery-edit-endpoint-showcase.md#L7",
              sourceLabel: {
                ko: "원문 요청과 이미지 · GPT-Image2-Skill",
                en: "Prompt and images · GPT-Image2-Skill"
              },
              input: {
                src: "/ab/2026-09a/cases/chess-midgame.png",
                alt: "체스 말과 대국 시계가 놓인 체스판",
                caption: "원문 입력·결과 비교 자료 / Original comparison asset"
              },
              output: {
                src: "/ab/2026-09a/cases/edit-chess-winter.png",
                alt: "눈 내리는 겨울 야외 테이블의 체스판",
                caption: "원문 입력·결과 비교 자료 / Original comparison asset"
              },
              promptKind: "source-summary",
              prompt: {
                ko: "말의 위치와 구도를 유지하고 눈 내리는 겨울 저녁으로 바꿉니다.",
                en: "Keep piece positions and composition; change to a snowy winter evening."
              },
              focus: {
                ko: "말·시계·보드 위치와 눈·조명의 변화를 대조합니다.",
                en: "Compare pieces, clock and board with the new snow and lighting."
              },
              limit: {
                ko: "GPT Image 2로 분류된 저장소 예제입니다. 개별 실행 기록은 공개 자료에 없으며 Images 2.5 결과로 비교하지 않습니다.",
                en: "Repository example categorized as GPT Image 2. Individual run records are unavailable; this is not an Images 2.5 result."
              }
            },
            {
              id: "poster-ad",
              title: {
                ko: "완성된 포스터를 광고판에 넣기",
                en: "Place a poster in an ad display"
              },
              model: "GPT Image 2 · repository example",
              kind: "community",
              sourceUrl: "https://github.com/wuyoscar/GPT-Image2-Skill/blob/7268a1d977c3084527ef349e94bd7e032f06ea2f/skills/gpt-image/references/gallery-edit-endpoint-showcase.md#L20",
              sourceLabel: {
                ko: "원문 요청과 이미지 · GPT-Image2-Skill",
                en: "Prompt and images · GPT-Image2-Skill"
              },
              input: {
                src: "/ab/2026-09a/cases/tea-poster.png",
                alt: "한자 제목과 16·19 가격, 차와 과일이 배치된 음료 포스터",
                caption: "원문 입력·결과 비교 자료 / Original comparison asset"
              },
              output: {
                src: "/ab/2026-09a/cases/tea-poster-metro-lightbox.png",
                alt: "음료 포스터를 지하철 광고판에 배치한 결과",
                caption: "원문 입력·결과 비교 자료 / Original comparison asset"
              },
              promptKind: "source-summary",
              prompt: {
                ko: "포스터의 글자와 디자인을 보존해 지하철 광고판 안에 배치합니다.",
                en: "Preserve the poster’s text and design inside a subway ad display."
              },
              focus: {
                ko: "제목·16/19 가격·QR 모양, 원근과 반사를 확인합니다. QR의 실제 연결 여부는 별도로 시험해야 합니다.",
                en: "Check the title, 16/19 prices, QR pattern, perspective and reflections. Test the QR destination separately."
              },
              limit: {
                ko: "GPT Image 2로 분류된 저장소 예제입니다. 개별 실행 기록은 공개 자료에 없으며 Images 2.5 결과로 비교하지 않습니다.",
                en: "Repository example categorized as GPT Image 2. Individual run records are unavailable; this is not an Images 2.5 result."
        ...
        threadsUrl: "https://www.threads.com/@voidlight00/post/DdBpcyFk5Aa"
      },
      sourceWeek: "2026-w37",
      sourceCompany: "OpenAI",
    ...
    },
    {
      ...
      post: {
        ...
        en: {
          ...
          summary: "Atlas was announced on September 1 and remains in early access. Explore the official spatial demonstrations and compare Atlas with the currently available Marble service. Treat unseen generated regions as estimates rather than measurements.",
          content: "Atlas was announced on September 1 and remains in early access. Explore the official spatial demonstrations and compare Atlas with the currently available Marble service. Treat unseen generated regions as estimates rather than measurements."
        },
    ...
    },
    {
      ...
      post: {
        ...
        thumbnail: {
          ...
          caption: "Google이 공개한 Lyria 3.5 기사 대표 이미지입니다.",
          provenance: "source-share-preview"
        },
        tags: [
          "2026-09a",
        ...
        en: {
          ...
          summary: "Google released Lyria 3.5 in Gemini on September 4. Listen to the official examples, then try requesting two instrumental arrangements for the same workshop opening and compare the instruments, mood and ending.",
          content: "Google released Lyria 3.5 in Gemini on September 4. Listen to the official examples, then try requesting two instrumental arrangements for the same workshop opening and compare the instruments, mood and ending."
        },
        releaseScope: "Gemini 앱 / API"
      },
      sourceWeek: "2026-w36",
      sourceCompany: "Google DeepMind",
      editorial: "같은 장면을 위한 음악에서 악기와 보컬 지시를 바꾸고, 요청이 소리에 어떻게 반영되는지 비교할 수 있습니다."
    }
  ],
  editorsPicks: [
    {
      title: "ego (lite) — 로그인한 브라우저를 에이전트에게 그대로 넘깁니다",
      slug: "ego-lite-agent-browser",
      deck: "Claude Code와 Codex가 내 로그인 상태를 쓰면서도 내 창을 건드리지 않습니다.",
      subtitle: "기존 공개 도구의 실전 활용",
      category: "공개 도구 · 브라우저 자동화",
      sourceUrl: "https://lite.ego.app/",
      sourceLabel: "공식 프로젝트",
      guideUrl: "https://github.com/citrolabs/ego-lite/blob/main/LICENSE",
      guideLabel: "코드 사용 조건",
      summary: "에이전트에게 웹 작업을 맡길 때 로그인·인증 단계에서 막히던 문제를 다루는 도구",
      body: "에이전트에게 웹 작업을 맡기면 대개 로그인에서 멈춥니다. 빈 브라우저를 새로 띄우니 계정 인증과 2단계 인증을 매번 다시 거쳐야 하고, 반대로 쓰던 창을 그대로 내주면 작업하던 탭이 흔들립니다. Citro Labs가 공개한 ego (lite)는 이 두 문제를 함께 다루는 Chromium 기반 브라우저입니다. 기존 Chrome 설정을 한 번에 가져와 평소처럼 쓰면서, 에이전트에게는 같은 로그인 상태를 별도의 작업 공간으로 내줍니다.\n\n연결은 ego-browser라는 공개 스킬이 담당합니다. 한 번 설치하면 Claude Code, Codex, Cursor, OpenCode 등 코드를 작성하는 에이전트가 같은 브라우저를 사용합니다. 공식 문서는 에이전트에서 /ego-browser를 입력한 뒤 원하는 작업을 말하면 각자의 Space에서 실행된다고 안내합니다. Space는 사람과 에이전트가 각각 나눠 쓰는 작업 공간이며, 사용자의 탭과 에이전트의 탭이 서로 섞이지 않도록 분리하는 장치입니다.\n\n첫 실습은 로그인이 필요하지만 되돌리기 쉬운 일부터 잡는 편이 좋습니다. 본인 계정의 게시글 목록을 읽어 표로 정리하게 하거나, 사내 도구의 특정 화면을 열어 항목 수를 세게 하는 정도가 적당합니다. 글을 올리거나 예약을 확정하는 작업은 되돌리기 어려우므로 읽기 작업으로 먼저 확인합니다. 결과 판단은 화면이 열렸는지가 아니라, 에이전트가 가져온 값이 직접 열어 본 화면과 같은지로 합니다.\n\n공식 사이트는 자사 공개 벤치마크에서 복잡한 브라우저 작업이 agent-browser 대비 최대 3.45배 빠르고 토큰도 적게 든다고 설명합니다. 회사가 스스로 측정한 값이며 독립 검증 결과가 아니므로, 본인 과제에서 걸린 시간과 재시도 횟수를 직접 기록해 비교하십시오. 현재 다운로드는 macOS용이 무료로 제공되고 Windows는 출시 알림을 신청하는 단계입니다. 코드는 MIT 라이선스입니다. 공식 문서에는 한국어 페이지도 있습니다.\n저장소: https://github.com/citrolabs/ego-lite\n한국어 문서: https://lite.ego.app/ko\n\n로그인 상태를 그대로 공유하는 도구이므로 접근 범위를 먼저 정해야 합니다. 개인 메일이나 금융 계정이 함께 로그인된 프로필을 넘기지 말고, 실습용 계정이나 권한이 제한된 프로필로 시작하십시오. 에이전트가 어떤 사이트까지 열 수 있는지, 되돌릴 수 없는 동작을 어디서 막을지 먼저 정한 뒤 사용합니다.",
      editorial: "에이전트에게 웹 작업을 맡길 때 로그인·인증 단계에서 막히던 문제를 다루는 도구",
      tags: [
        "공개 도구",
        "MIT",
        "실습 제안"
      ...
      tier: "feature",
      thumbnail: {
        src: "/og-cache/ab-20260910-ego-lite.png",
        alt: "ego (lite) 공식 사이트가 공유용으로 제공하는 에이전트 브라우저 소개 이미지",
        caption: "ego (lite) 공식 사이트의 공유 이미지입니다. 본문 상단에는 별도 대표 이미지가 없어 이 이미지를 사용했습니다.",
        provenance: "source-share-preview"
      }
    },
    {
  ...
  modelWatch: [
    ...
    {
      title: "초파리 커넥톰 — 뉴런 16만 개 배선도가 마인크래프트에서 움직입니다",
      slug: "fly-connectome-minecraft",
      deck: "공개된 신경 배선도를 사흘 만에 게임 안에서 만져 보는 형태로 재구성했습니다.",
      category: "과학 · 연구 공개",
      sourceUrl: "https://research.google/blog/a-connectomics-milestone-mapping-the-complete-male-fruit-fly-brain/",
      sourceLabel: "공식 연구 발표",
      summary: "9월 3일 공개된 수컷 초파리 중추신경계 배선도와, 그 자료로 만든 마인크래프트 신경망 시연입니다. 살아 있는 초파리를 재현했다는 뜻은 아닙니다.",
      body: "**16만 6천 개 뉴런의 배선도가 공개됐습니다**\n\nHHMI Janelia와 Google Research, MRC 분자생물학연구소, 케임브리지대학이 9월 3일 수컷 초파리 중추신경계의 배선도를 공개했습니다. 뉴런 16만 6천여 개와 시냅스 연결 1억 2,500만 개를 담았고, 중앙 뇌와 시엽뿐 아니라 척수에 해당하는 복부 신경삭까지 포함합니다. 뉴런 수를 기준으로 지금까지 만들어진 가장 큰 뇌 지도입니다. 자료는 공개 도구 Neuroglancer로 열어 볼 수 있고 아래 주소에서 내려받습니다.\nhttps://male-cns.janelia.org\n\n**사흘 뒤 같은 자료가 게임 안으로 들어갔습니다**\n\n조지아공대 대학원생 Evan Sinclair Smith는 이 자료로 NeuroCraft Fly를 만들어 9월 6일 저장소를 공개했습니다. 제작자는 X에 이 작업을 GPT-6 Astra의 도움으로 만들었다고 밝혔습니다. 앞의 Astra 카드에서 본 긴 작업 수행 능력이 실제로 어떤 결과로 이어졌는지 확인할 수 있는 공개 사례입니다. 다만 어느 단계를 얼마나 맡겼는지는 공개되어 있지 않습니다. MaleCNS 재구성에서 뉴런 166,700개와 방향성 연결 25,582,938개를 가져와, 마인크래프트 안에서 일어나는 먹이·빛·주변 생물·공격 같은 사건을 신경망의 입력으로 바꿉니다. 특정 뉴런 무리의 활동을 읽어 비행, 몸 손질, 섭식, 회피처럼 미리 작성해 둔 동작 중 하나를 고르는 구조입니다. 저장소는 접근, 몹, 스치기, 공격, 먹이, 빛 여섯 가지 상호작용을 실험으로 기록해 두었습니다.\n공개 저장소: https://github.com/evnsnclr/neurocraft-fly-public\n\n**살아 있는 초파리를 재현한 것은 아닙니다**\n\n제작자는 이 작업이 연결 관계를 눈으로 보고 시험할 수 있게 만든 것이며, 초파리의 생리나 자연 상태의 행동을 되살렸다는 뜻은 아니라고 명시합니다. 신경망 비교도 아직 검증 중이라고 밝힙니다. 지금 저장소에는 2분 27초 데모 영상과 배포 계획만 있고 실행 파일은 내려받을 수 없습니다. 문서는 MIT 라이선스이며 MaleCNS 자료는 Janelia가 정한 원래 이용 조건을 그대로 따릅니다. 접근 권한과 재배포 조건은 자료마다 따로 확인해야 합니다.\n\n**공개된 연구 자료가 다음 단계로 넘어가는 속도**\n\nGoogle Research는 신경의 형태를 검증하고 주석을 다는 데 사람의 손으로 수년이 걸린다고 설명하며, 뉴런 860억 개를 가진 사람의 뇌를 같은 방식으로 매핑하는 일은 아직 도달할 수 없다고 밝힙니다. 이번 사례에서 눈여겨볼 지점은 지도 자체의 규모보다, 공개된 연구 자료가 며칠 만에 일반 사용자가 직접 만져 보는 형태로 재구성됐다는 점입니다. 다만 게임 안의 반응이 실제 초파리의 반응과 같은지는 이 시연으로 확인되지 않습니다.",
      tags: [
        "커넥톰",
        "Google Research",
        "연구 공개"
      ...
      tier: "normal",
      thumbnail: {
        src: "/og-cache/ab-20260910-fly-connectome.jpg",
        alt: "수컷 초파리 중추신경계를 뉴런별로 색을 달리해 재구성한 Google Research 공식 글의 상단 이미지",
        caption: "뇌와 복부 신경삭이 신경 다발로 이어진 구조를 보여 주는 공식 재구성 이미지입니다. 공식 사이트가 제공하는 800px 파생본을 그대로 사용했습니다."
      }
    }
