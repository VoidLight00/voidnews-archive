  ...
  highlights: [
    {
      ...
      post: {
        ...
        en: {
          ...
          deck: "Connect documents, apps, and result checks in one scoped task.",
          summary: "Astra strengthens work across code, browsers, and desktop apps. Start with the default reasoning level, define the deliverable and verification steps, and measure completed work rather than response speed. The suggested live demonstration has not been executed.",
