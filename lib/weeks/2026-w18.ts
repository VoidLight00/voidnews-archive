    ...
    },
    {
      ...
      "posts": [
        ...
        },
        {
          "date": "날짜 미확인",
          "platform": "X",
          "title": "휴머노이드 로봇 댄스 영상 (Boston Dynamics 추정)",
          "summary": "영상 마지막 컷으로 'Boston Dynamics 신형 로봇이 사람보다 잘 춘다'며 인용한 short. 영상 본인의 추가 소개나 공식 Boston Dynamics 채널 게시는 미확인.",
          "content": "이게 뭐예요?\n영상 마지막 컷으로 'Boston Dynamics 신형 로봇이 사람보다 잘 춘다'며 인용한 short. 영상 본인의 추가 소개나 공식 Boston Dynamics 채널 게시는 미확인.\n\n왜 중요해요?\n이 항목은 이번 VOL.03의 도구릴리스 흐름에 속합니다. 수강생 입장에서는 최신 모델 이름을 외우는 것보다, 이 변화가 내 업무·학습·제작 흐름의 어느 부분을 바꾸는지 보는 것이 중요합니다.\n\n조금 더 풀어보면\n출처 추적 부분 실패 — X.com WebFetch가 차단되어 원본 트윗 내용 직접 확인 불가. 영상은 Boston Dynamics라 명시했으나, 같은 시기 Unitree·Tesla Optimus·HONOR 등 다른 회사의 댄스 영상도 viral 상태라 회사 식별이 확정되지 않음. 공식 발표 아닌 SNS 클립이므로 source_type=rumor로 표기.\n\n주의·확인 포인트\n루머 항목입니다. 루머 기반 항목입니다. 발표에서는 확정 사실처럼 말하지 말고, 다음 회차에서 검증할 신호로 설명하세요.",
