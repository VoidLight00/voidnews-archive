// Week 13 (3/20 ~ 3/26) — extracted verbatim from lib/data.ts (refactor, no content change)

import type { WeeklyData } from "../data";

export const week13: WeeklyData = {
  week: 13,
  year: 2026,
  slug: "2026-w13",
  period: "3/20 ~ 3/26",
      ...
      posts: [
        {
          ...
          thumbnail: {
            src: "/og-cache/ai-쓰는-사람들끼리-격차가-벌어지고-있다-anthropic-경제-지수--fe759b80.jpg",
            alt: "AI 쓰는 사람들끼리 격차가 벌어지고 있다 — Anthropic 경제 지수 3월 리포트",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/한국은-ai를-가장-잘-쓰면서-패배할-수-있다-문제는-실력이-아니다-cfb872e7.jpg",
            alt: "한국은 AI를 가장 잘 쓰면서 패배할 수 있다 — 문제는 실력이 아니다",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/claude-code-고수들의-비밀-5가지-당신이-매번-시간-낭비하는-이-ac55d1b1.png",
            alt: "Claude Code 고수들의 비밀 5가지 — 당신이 매번 시간 낭비하는 이유",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/93-가-무조건-y를-눌렀다-anthropic이-자율-모드를-만든-이유-ac55d1b1.png",
            alt: "93%가 무조건 Y를 눌렀다 — Anthropic이 자율 모드를 만든 이유",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/claude-code-이제-혼자-결정한다-auto-mode-공식-출시-00a1f67d.jpg",
            alt: "Claude Code, 이제 혼자 결정한다 — Auto Mode 공식 출시",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/obsidian-노트-안에서-claude-code를-실행한다-claudi-e5aa0b1d.jpg",
            alt: "Obsidian 노트 안에서 Claude Code를 실행한다 — Claudian 플러그인",
          },
        },
        {
        ...
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/승인-없이-스스로-판단하는-claude-auto-mode-안전-설계-원리-ac55d1b1.png",
            alt: "승인 없이 스스로 판단하는 Claude — Auto Mode 안전 설계 원리",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/anthropic이-공개한-에이전트-팀-운영법-장기-앱-개발의-새-공식-c0ecf553.jpg",
            alt: "Anthropic이 공개한 에이전트 팀 운영법 — 장기 앱 개발의 새 공식",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/ai가-잠드는-방법-렘수면에서-영감-받은-에이전트-메모리-설계-bceff5ac.png",
            alt: "AI가 잠드는 방법 — 렘수면에서 영감 받은 에이전트 메모리 설계",
          },
        },
        {
        ...
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/computer-use-다음은-phone-use-claude가-스마트폰을-a6a869ed.jpg",
            alt: "Computer Use 다음은 Phone Use — Claude가 스마트폰을 직접 조작한다",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/claude가-내-맥을-직접-클릭한다-macos-컴퓨터-제어-첫-데모-a6a869ed.jpg",
            alt: "Claude가 내 맥을 직접 클릭한다 — macOS 컴퓨터 제어 첫 데모",
          },
        },
        {
          ...
          threadsUrl: "https://www.threads.com/@voidlight00/post/DWQdAQ7D1zH",
          thumbnail: {
            src: "/og-cache/anthropic이-연구-블로그를-열었다-이제-논문도-직접-읽는다-b0327102.jpg",
            alt: "Anthropic이 연구 블로그를 열었다 — 이제 논문도 직접 읽는다",
          },
        },
        {
        ...
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/당신이-몰랐던-claude-code-고수들의-50가지-사용법-e92f46d4.png",
            alt: "당신이 몰랐던 Claude Code 고수들의 50가지 사용법",
          },
        },
        {
          date: "3/27",
          ...
          thumbnail: {
            src: "/og-cache/claude-code에-외부-도구를-연결하는-법-mcp-서버-가이드-640dc3f4.jpg",
            alt: "Claude Code에 외부 도구를 연결하는 법 — MCP 서버 가이드",
          },
        },
        {
          date: "3/27",
          ...
          thumbnail: {
            src: "/og-cache/손-안에서-ai-에이전트를-지휘한다-claude-dispatch-모바일--5add4bf1.jpg",
            alt: "손 안에서 AI 에이전트를 지휘한다 — Claude Dispatch 모바일 제어",
          },
        },
        {
          date: "3/27",
    ...
    },
    {
      ...
      posts: [
        ...
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/chatgpt에-갤러리가-생겼다-ai-이미지-히스토리-관리-탭-추가-9df6b54f.jpg",
            alt: "ChatGPT에 갤러리가 생겼다 — AI 이미지 히스토리 관리 탭 추가",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/python-생태계를-인수했다-openai의-astral-흡수와-그-의미-1ba70278.jpg",
            alt: "Python 생태계를 인수했다 — OpenAI의 Astral 흡수와 그 의미",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/작고-빠른-gpt-5-4-mini-저비용-추론의-새-선택지-d8b55541.png",
            alt: "작고 빠른 GPT-5.4 mini — 저비용 추론의 새 선택지",
          },
        },
        {
      ...
      posts: [
        {
          ...
          thumbnail: {
            src: "/og-cache/llm의-메모리-병목을-뚫는다-google-turboquant-공개-7212e038.jpg",
            alt: "LLM의 메모리 병목을 뚫는다 — Google TurboQuant 공개",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/3분짜리-프로-음악을-ai가-만든다-lyria-3-pro가-바꾸는-창작의-9dfadafb.jpg",
            alt: "3분짜리 프로 음악을 AI가 만든다 — Lyria 3 Pro가 바꾸는 창작의 경계",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/뇌와-몸의-결합-deepmind-알고리즘이-로봇-몸통을-얻다-4f26ec5d.jpg",
            alt: "뇌와 몸의 결합 — DeepMind 알고리즘이 로봇 몸통을 얻다",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/더-작고-더-빠른-gemini-모바일에서-달리는-flash-lite-1cc3982b.jpg",
            alt: "더 작고 더 빠른 Gemini — 모바일에서 달리는 Flash-Lite",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/말로-ui를-만든다-google-stitch에-음성-입력이-추가됐다-817529ae.jpg",
            alt: "말로 UI를 만든다 — Google Stitch에 음성 입력이 추가됐다",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/gemini-하나로-풀스택을-짠다-ai-studio-바이브-코딩-데모-ea743660.jpg",
            alt: "Gemini 하나로 풀스택을 짠다 — AI Studio 바이브 코딩 데모",
          },
        },
        {
          date: "3/27",
      ...
      posts: [
        {
          ...
          thumbnail: {
            src: "/og-cache/외부로-나가지-않는-cursor-프라이빗-클라우드-에이전트-완성-fdaf21be.png",
            alt: "외부로 나가지 않는 Cursor — 프라이빗 클라우드 에이전트 완성",
          },
        },
        {
        ...
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/파일-수백-개를-한-번에-cursor-composer-2-대규모-리팩토링-02cc3eed.png",
            alt: "파일 수백 개를 한 번에 — Cursor Composer 2 대규모 리팩토링",
          },
        },
      ],
    },
      ...
      posts: [
        {
          ...
          thumbnail: {
            src: "/og-cache/elon이-반도체-공장을-짓는다-xai-terafab-두-번째-공개-422d9da1.jpg",
            alt: "Elon이 반도체 공장을 짓는다 — xAI Terafab 두 번째 공개",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/ai-반도체를-직접-만들겠다-xai-terafab-첫-발표-b8bbe927.jpg",
            alt: "AI 반도체를 직접 만들겠다 — xAI Terafab 첫 발표",
          },
        },
      ],
    },
    {
      ...
      posts: [
        ...
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/agi를-위한-칩을-함께-만든다-meta와-arm-cpu-협력-전면-해부-b89713f6.jpg",
            alt: "AGI를 위한 칩을 함께 만든다 — Meta와 Arm CPU 협력 전면 해부",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/클라우드-ai를-독립시킨다-meta의-자체-ai-칩-전략-b89713f6.jpg",
            alt: "클라우드 AI를 독립시킨다 — Meta의 자체 AI 칩 전략",
          },
        },
      ],
    },
      ...
      posts: [
        {
          ...
          thumbnail: {
            src: "/og-cache/생각하면서-그린다-luma-uni-1이-바꾼-이미지-생성의-규칙-42d6b984.jpg",
            alt: "생각하면서 그린다 — Luma Uni-1이 바꾼 이미지 생성의 규칙",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/5배-빠르고-2k-해상도-midjourney-v8이-기준을-다시-썼다-09bfcd8b.jpg",
            alt: "5배 빠르고 2K 해상도 — Midjourney V8이 기준을 다시 썼다",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/ai-음악을-팔-수-있게-됐다-elevenlabs-음악-마켓플레이스-89b53493.jpg",
            alt: "AI 음악을 팔 수 있게 됐다 — ElevenLabs 음악 마켓플레이스",
          },
        },
        {
          date: "3/27",
          ...
          thumbnail: {
            src: "/og-cache/여러-장면을-한-번에-연결한다-runway-multi-shot-app-출-6fabc610.jpg",
            alt: "여러 장면을 한 번에 연결한다 — Runway Multi-Shot App 출시",
          },
        }
      ],
    },
    {
      ...
      posts: [
        ...
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/디자인에서-코드로-바로-copilot이-figma-디자인을-직접-읽는다-ea50140e.jpg",
            alt: "디자인에서 코드로 바로 — Copilot이 Figma 디자인을 직접 읽는다",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/agi를-측정하는-새-잣대-arc-agi-3-공개-a1b18357.jpg",
            alt: "AGI를 측정하는 새 잣대 — ARC-AGI-3 공개",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/gmail-docs-sheets-meet-google-전-제품에-gemi-3fc4e2b8.jpg",
            alt: "Gmail, Docs, Sheets, Meet — Google 전 제품에 Gemini가 들어갔다",
          },
        },
        {
          ...
          thumbnail: {
            src: "/og-cache/ai가-증상을-분석한다-perplexity-computer의-의료-데이터-9f1ec8ec.jpg",
            alt: "AI가 증상을 분석한다 — Perplexity Computer의 의료 데이터베이스 연동",
          },
        },
        {
          date: "3/27",
          ...
          thumbnail: {
            src: "/og-cache/ai가-figma-캔버스에-직접-그린다-figma-mcp-첫-데모-ea50140e.jpg",
            alt: "AI가 Figma 캔버스에 직접 그린다 — Figma MCP 첫 데모",
          },
        },
        {
          date: "3/27",
          ...
          thumbnail: {
            src: "/og-cache/말로-자동화를-만든다-n8n의-mcp-자연어-워크플로우-e28ebcc6.png",
            alt: "말로 자동화를 만든다 — n8n의 MCP 자연어 워크플로우",
          },
        }
      ],
    },
