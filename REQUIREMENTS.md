...
| R18 | 9월 두 번째 VIP는 본편 6개(같은 날 나온 두 모델은 별도 카드)·추가로 보면 좋을 뉴스 2개·공개 도구 2개를 지정 순서로 갖추고, 원문 이미지 해시와 자체 발표 수치·비상업 라이선스·도구 접근 범위 표기를 지켜야 합니다. | check-ab-2026-09b.mjs |
