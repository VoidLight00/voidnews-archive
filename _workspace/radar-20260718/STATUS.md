...
- fixture selftest: 완전 기록 기대 exit 0 / 1건 누락 기대 exit 2 / 필수 필드 누락 기대 exit 2 / dateRange 불일치 기대 exit 2를 재현했고 runner exit 0.
...
```text
PASS[video-coverage-selftest] complete=0 missing=2 invalid-fields=2 invalid-range=2
SELFTEST_EXIT=0
